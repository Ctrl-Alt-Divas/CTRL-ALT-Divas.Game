    ...
    if (foundCanvas && characters && characters?.length > 0 && id && player) {
      ...
      App.run({
        ...
        loader: [
          ...
          {
            key: "floatingtile",
            data: new URL("./sprites/keyboard.png", import.meta.url).href,
          },
          {
            key: "tile",
          ...
          },
          {
            ...
            data: new URL("./sprites/characters/fancy1.png", import.meta.url)
              .href,
          },
          {
            key: "Fancypants-walk2",
            data: new URL("./sprites/characters/fancy2.png", import.meta.url)
              .href,
          },
          {
            key: "Lani-walk1",
            data: new URL("./sprites/characters/lani1.png", import.meta.url)
              .href,
          },
          {
            key: "Lani-walk2",
            data: new URL("./sprites/characters/lani2.png", import.meta.url)
              .href,
          },
          {
            key: "Lilypad-walk1",
            data: new URL("./sprites/characters/lilypad1.png", import.meta.url)
              .href,
          },
          {
            key: "Lilypad-walk2",
            data: new URL("./sprites/characters/lilypad2.png", import.meta.url)
              .href,
          },
          {
            key: "Eli-walk1",
            data: new URL("./sprites/characters/Eli1.png", import.meta.url)
              .href,
          },
          {
            key: "Eli-walk2",
            data: new URL("./sprites/characters/Eli2.png", import.meta.url)
              .href,
          },
        ],
        scenes: {
