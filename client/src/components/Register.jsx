...
function Register() {
  ...
  <>
   <form onSubmit={handleSubmit}>
    ...
    <label>
      Username:
      <input value={player.username} onChange={(e) => setPlayer({...player, username: e.target.value})} required />
    </label>
    <label>
      password:
      <input value={player.password} onChange={(e) => setPlayer({...player, password: e.target.value})} required />
    </label>
