...
async function createInitialData() {
  try {
    ...
    await client.query(`
      INSERT INTO character (name, description, shrtdescription, speed, jump)
      VALUES
